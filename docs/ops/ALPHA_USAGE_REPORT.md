...
| 3 | Sweep (small) | 2026-08-08T05:54:45Z | | | | | **In progress** — small ranges → lattice → View → wait upload synced |
...
- Device phase: matrix **#3 Sweep** started 2026-08-08T05:54:45Z (tester: `start:3`)
