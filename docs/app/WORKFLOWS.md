...
| [ ] 3b.6f3b | Read the last line of either speckle dialog on a phone that reports no focus distance | The millimetre figure is stated as **not available**, with the reason, rather than silently missing — most phones land here, and a user hunting for an absent number learns nothing |
